const echo = {
    ...
    weapon: {
        ...
        advancement: {
            star1: `Пробивание увеличивается на **15%**. При пробивании щита цели увеличивает АТК всех союзников на **15%** в течение **30** секунд. Эффект не складывается.`,

            star2: `Базовый прирост здоровья увеличивается на **10%**.`,

            star3: `При попадании *Лунным охотником* уменьшает АТК поражённых целей на **5%** и увеличивает АТК персонажа на **5%** в течение **15** секунд (эффект складывается до **3** раз при задевании навыком больше одной цели). Сила эффекта удваивается на целях с тяжёлыми ранами.`,

            star4: `Базовый прирост АТК увеличивается на **20%**.`,

            star5: `Удваивает продолжительность оглушения навыков уклонения.`,

            star6: `Чем дальше пролетает навык высвобождения до цели, тем больше он наносит урона, вплоть до максимального бонуса в **100%**.`
        },
        abilities: {
            normal: [
                {
    ...
    matrix: {
        set3: "При применении навыка высвобождения этого оружия восстанавливается **80/100/120** очков заряда."
    },
    ...
    cnData: {
        ...
        weapon: {
            advancement: {
                star5: `<abbr title='China Exclusive'></abbr> Удваивает продолжительность оглушения навыков уклонения вперёд.`
            }
        }
    }
}
