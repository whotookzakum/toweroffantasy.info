    ...
    weapon: {
		...
		bonusEffect: {
            effect1: {
                ...
                description: 
                    `Увеличивает Физ. АТК на **15%** и Физ. Сопротивление на **25%**. Активируется при ношении **2** или более физических оружий. Эффект не может складываться и работает пассивно при любом активном оружии.`
            }
        },
        advancement: {
            star1: `Попадание активным навыком или навыком высвобождения накладывает на персонажа эффект, увеличивающий наносимый урон на **8%** в течение 25 секунд. Эффект складывается до **3** раз. За одно применение активного навыка или навыка высвобождения можно получить только один такой эффект.`,

            star2: `Базовый прирост АТК увеличивается на **16%**.`,

            star3: `Попадание активным навыком или навыком высвобождения накладывает на цель эффект Боевых ран, увеличивая входящий Физ. Урон и пробивание по этой цели на **10%** в течение 15 секунд. Эффект не складывается.`,

            star4: `Базовый прирост к здоровью увеличивается на **32%**.`,

            star5: `Попадание активным навыком или навыком высвобождения увеличивает весь наносимый урон на **20%** в течение **25** секунд. Эффект не складывается.`,
        ...
        abilities: {
            normal: [
                {
                    ...
                    breakdown: [
                        'Наносит **39%** от АТК + **2** урона и несильно отбрасывает цель.',
                        'Наносит **54,6%** of ATK + **3** урона и несильно отбрасывает цель.',
                        'Наносит **49,4%** of ATK + **3** урона и несильно отбрасывает цель.',
                        'Наносит **87%** of ATK + **5** урона и несильно отбрасывает цель.',
                        'Наносит **148,1%** of ATK + **8** урона и **подбрасывает** цель.'
                    ]
                },
                {
                    name: "Удар в прыжке",
                    ...
                    breakdown: [
                        ...
                        'Наносит **40,3%** от АТК + **2** урона',
                        'Наносит **95,4%** от АТК + **5** урона',
                        'Наносит **115,8%** от АТК + **6** урона и **сбивает** цель.'
                    ]
                },
                {
                    name: "Циклон",
                    input: ["Атака","Удерживание"],
                    description: `Нажмите и удерживайте кнопку удара после совершённой базовой атаки, чтобы подбросить цель, подвешивая её в воздухе и нанося **39,8%** от АТК + **2** урона.`,
                },
                {
            ...
            skill: [
                {
                    name: "Скитание",
                    description: `Танцует сквозь цели с клинком в руках, нанося **348,5%** от АТК + **18** суммарного урона до **5** целям (атаки по одной и той же цели наносят на **20%** меньше урона). В конце разрезает пространство перед собой, нанося **264%** от АТК + **14** урона целям и подбрасывая их в воздух. Во время применения навыка персонаж неуязвим к эффектам контроля. Перезарядка: **15** секунд.`,
                }
            ],
            discharge: [
                {
