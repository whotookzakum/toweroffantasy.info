const huma = {
    ...
    weapon: {
        ...
        advancement: {
            ...
            star3: `Навыки уклонения и ответвления наносят дополнительный урон в форме щита, равный **4%** от текущего здоровья персонажа.`,
            ...
            star6: `Улучшает навыки смены формы оружия.  
