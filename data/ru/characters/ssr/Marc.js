const marc = {
    ...
    weapon: {
        ...
        bonusEffect: {
            ...
            effect2: {
                title: `Усиление`,
                description: `**[БЕЗ КОМАНДЫ]** Меха-броня уменьшает получаемый Физ. Урон на **50%**.`
            },
            effect3: {
        ...
        advancement: {
            ...
            star2: `Базовый прирост к здоровьюувеличивается на **16%**.`,

            star3: `Когда [Пространственный щит] разрушается или обновляется, финальный урон персонажа увеличивается на **35%** в течение **20** секунд. Эффект не складывается.`,
            ...
            star6: `Когда [Пространственный щит] активен, Физ. Сопротивление **удваивается**, и персонаж также получает эффект Гипертела. [Пространственный щит] может быть получен, когда активный навык или навык высвобождения другого оружия попадает в цель при активном щите.`
        },
        abilities: [],
    },
