const crow = {
    ...
    cnData: {
        name: "Ворон (Карасума)",
        matrix: {
            set2: `<abbr title='China Exclusive'></abbr> Крит. урон увеличивается на **33%/42%/50%/58%** против целей, чьё здоровье ниже **60%**.`,

            set4: `<abbr title='China Exclusive'></abbr> Крит. удары на **5** секунд накладывают эффект периодического урона, каждую секунду наносящий урон, равный **12%/15%/18%/21%** от АТК. Эффект не складывается.`
        }
    }
}
