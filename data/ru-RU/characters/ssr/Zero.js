const zero = {
    ...
    weapon: {
        ...
        advancement: {
            ...
            <abbr title='China Exclusive'></abbr> Нанося урон, создаёт усиливающую сферу, которая существует **20** секунд и увеличивает АТК на **2%** любому её поднявшему союзнику. Усиление складывается до **10** раз и длится **45** секунд. Перезарядка: **2,5** секунды.`,
    ...
    matrix: {
        set2: `Использование навыка высвобождения этого оружия создаёт щит на **4** секунды, который способен заблокировать урон, равный **120%/150%/180%/210%** от АТК.  
            <abbr title='China Exclusive'></abbr> Использование навыка высвобождения этого оружия создаёт щит на **6** секунд, который способен заблокировать урон, равный **150%/200%/250%/300%** от АТК.`,
