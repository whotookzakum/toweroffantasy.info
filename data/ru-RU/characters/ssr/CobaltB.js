const cobalt = {
    ...
    weapon: {
        ...
        advancement: {
            ...
            star3: 'Навык Разрывные пули и атака в уклонении на **10** секунд накладывают [Ионный ожог] на уже горящие цели, каждую секунду нанося урон, равный **90%** от АТК.',

            star4: "Базовый прирост АТК оружия увеличивается на **32%**.",

            star5: "Урон [Ионного ожога] увеличивается до **140%**. Попадание атакой в уклонеии любого оружия обновляет время действия [Ионного ожога] на целях.",
