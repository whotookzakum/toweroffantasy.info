const coco = {
    ...
    awakening: [
            ...
            // 3 star
            `Use <strong class='text-orange'>Sanctuary</strong>** or discharge skills to remove debuffs from targets, can be used while being affect by control effects. Increase shatter and damage dealt for all teammates within range by **20%**, and grant them immunity to control effects and shatter.`,
            // 4 star
