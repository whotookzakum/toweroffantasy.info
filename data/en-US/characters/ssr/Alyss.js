const alyss = {
    ...
    matrix: {
        ...
        set4: `Unleashing a discharge skill with Immortal Wings grants a **12%/13.5%/15%/17%** damage boost for **18** seconds, stacking up to **2** times. Lose **1** stack when the buff expires. This effect works in the background, and if multiple sets are used, the highest star set will take effect. Stamina consumption is reduced by **50%** during Subtle Formation.`
    },
