const spacetimerift = {
    ...
    advancement: {
        ...
        star2: "Increase the target area by **100%**.",

        star3: "Increase damage dealt to targets in the area by **20%**.",

        star4: "Reduce flame damage received by **2%**, even if not deployed. Unavailable in Apex League.",

        star5: "Enemies within the rift are unable to receive any healing."
    },
    videoSrc: "https://www.youtube.com/embed/esWKppfYrrc",
    starsInVideo: "2"
}
