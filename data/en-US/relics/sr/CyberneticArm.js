const cyberneticarm = {
    ...
    advancement: {
        star1: "Produce an EM shield that reduces damage taken by **20%** for 7 seconds.",

        star2: "Regain **1** charge every **15** seconds.",

        star3: "Store up to **3** charges.",

        star4: "Increase frost damage by **1.5%**, even if not deployed. Unavailable in Apex League.",

        star5: "Reduce final damage of targets hit by **30%** for **7** seconds."
    },
    videoSrc: "https://www.youtube.com/embed/Aa13QZJiahA",
    starsInVideo: "3"
}
