<div class="unreleased-warning">
    <strong>Warning: Unreleased Content</strong>
    <p>
        ...
        change upon official release.
    </p>
</div>

<style lang="scss">
    .unreleased-warning {
        background: rgb(99, 78, 34);
        border-left: 4px solid rgb(204, 148, 27);
        padding: 1rem;
        margin-top: 2rem;
        display: grid;
        gap: 0.5rem;
