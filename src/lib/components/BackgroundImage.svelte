<script>
    ...
    const getImgSrc = (path) => {
        ...
        if (path.includes("triple-mask")) return 'Artifact/itemicon/artifact_ssr_021'
        if (path.includes("bubble-gun")) return 'Artifact/itemicon/artifact_ssr_020'
        if (path.includes("oceans-heart")) return 'Artifact/itemicon/artifact_ssr_018'
        if (path.includes("booster-shot")) return 'Artifact/itemicon/artifact_ssr_016'
        if (path.includes("mini-pelican")) return 'Artifact/itemicon/artifact_ssr_015'
