...
// NOTE: Banners fetch from the global version, as CN is not implemented for banners.
export const load = async (event) => {
    ...
    const bannersRes = await bannersQuery.fetch({ event, variables: { version: "china", lang: "en" } })
