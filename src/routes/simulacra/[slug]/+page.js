...
const data = {
        ...
        weaponEffects: [
            {
                ...
                description: `Increase volt ATK by **20%** and volt resistance by **40%**. Activate by equipping **2** or more volt weapons. This set effect also works with weapons in the off-hand slot. Volt Resonance will take priority if equipped with a Volt Reaction weapon.`,
            },
            {
                title: "Balanced Elements",
                description: `Increase all ATK by **15%**. Activate by equipping **3** weapons with different elements. This effect works in the background.`,
            },
        ],
        advancements: [
        ...
        abilities: [
            {
                name: "Wang Ming",
                type: "normal",
                imgSrc: "skill_fenrir_melee",
                input: ["Attack x7"],
                description: `While on the ground, attack 7 times.`,
                breakdown: [
            ...
            },
            {
                name: "Wolf Bite",
                type: "normal",
                imgSrc: "skill_fenrir_branch1",
                input: ["Attack x2 or x4", "hold:Attack"],
                description: `While on the ground, hold the attack button after the 2nd or 4th basic attack to trigger Wolf Bite. Charge forward quickly and deal **114%** of ATK + **6** damage and knock back the target. After triggering Wolf Bite, press and hold the basic attack to trigger an uppercut. Perform an upward claw swipe, dealing **153.9%** of ATK + **8** damage and **suspend** the target.`,
            },
            {
                name: "Wild Hunt",
                type: "normal",
                imgSrc: "skill_fenrir_branch3",
                input: ["Attack x5 or x6", "hold:Attack"],
                description: `While on the ground, hold the attack button after the 5th or 6th basic attack to trigger Wild Hunt. Fall from the sky, becoming temporarily invincible, to deal **420.3%** of ATK + **22** damage and **suspend** the target.`,
            },
            {
                name: "Impact Fall",
                type: "normal",
                imgSrc: "skill_fenrir_jumpattack",
                input: ["Jump", "hold:Attack", "hold:Attack"],
                description: `While airborne, climbing, using the jetpack, or reverse jump attacking, hold the attack button to trigger Impact Fall. Falling from the sky, crash into the ground to deal **330.6%** of ATK + **17** damage to and **suspend** nearby targets. Afterwards, hold the attack button again to trigger Roar, granting temporary invincibility and dealing **330.6%** of ATK + **17** and knocking enemies back.`,
            },
            {
                name: "Soundtrack",
                type: "normal",
                imgSrc: "skill_fenrir_airattackbranch",
                input: ["Jump", "Attack", "hold:Attack"],
                description: `While airborne, hold the attack button after the 2nd attack of Prisonbreak to trigger Soundtrack. Dash through the air in multiple directions, dealing **458.3%** of ATK + **24** damage.`,
            },
            {
                name: "Reverb",
                type: "normal",
                imgSrc: "skill_fenrir_beidong",
                description: `Each attack has a **50%** chance of adding **1** note to the target, lasting **15** seconds and maxing out at **5** notes.  
            ...
            },
            {
                name: "Echo",
                type: "dodge",
                imgSrc: "skill_fenrir_evadeattack",
                input: ["Dodge", "Attack"],
                description: `Perform a close range claw attack, dealing **383.2%** of ATK + **20** to surrounding targets and knocking them down.`,
            },
            {
                name: "Dodge",
                type: "dodge",
            ...
            },
            {
                name: "Ovation",
                type: "discharge",
                imgSrc: "skill_fenrir_changeskill",
        ...
        recommendedMatrices: [
            {
                ...
                pieces: 4,
                description:
                    "Fenrir's matrices are absurdly powerful and ideally should be used on other weapons since they work in the background, but if all your matrices work in the background, using them on Gleipnir is fine.",
            },
            {
                name: "Samir",
                pieces: 2,
                description:
                    "Gleipnir can easily maintain the full buff with its fast attacks and passive damage refreshing stacks. Samir and Crow/Shiro matrices are a very good option if you don't have Fenrir matrices or are using them in the background.",
            },
            {
                name: "Crow",
                pieces: 2,
                description:
                    "High damage matrix set when you have high crit rate. Gleipnir's 6th advancement grants crit rate so may be more effective than usual, displacing Shiro 2-piece.",
            },
            {
                name: "Sobek",
                pieces: 3,
    ...
    matrices: [
        {
            pieces: 2,
            description: `Crit damage increased by **20%/24%/28%/32%**, does not stack. This effect works in the background, and if multiple sets are used, only the highest star set will take effect.`
        },
        {
            pieces: 4,
            description: `Dealing volt damage increases final damage by **5%** for **10** seconds, up to **5/6/7/8** stacks. This effect works in the background, and if multiple sets are used, only the highest star set will take effect.`
        },
    ],
    ...
    awakening: {
        traits: [
            {
                affinity: 1200,
                description: `When equipping **2** weapons of different elements, increase final damage by **13%**. When equipping **3** weapons of different elements, increase final damage by **18%**.`
            },
            {
                affinity: 4000,
                description: `When equipping **2** weapons of different elements, increase final damage by **18%**. When equipping **3** weapons of different elements, increase final damage by **25%**.`
            }
        ],
