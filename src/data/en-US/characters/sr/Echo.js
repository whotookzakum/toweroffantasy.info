const echo = {
    ...
    weapon: {
        ...
        advancement: {
            ...
            star3: `After hitting a target with <strong class='text-green'>Moonchase**, reduce their ATK by **5%** and increase the user's ATK by **5%** for **15** seconds (effect can be stacked up to **3** times by hitting multiple targets). Effect is doubled to grievous targets.`,
