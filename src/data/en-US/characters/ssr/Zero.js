const zero = {
    ...
    weapon: {
        ...
        advancement: {
            ...
            <abbr title='China Exclusive' /> Deal damage and produce a damage orb, which lsts for **20** seconds and increases ATK of any teammate who picks it up by **2%**. Stacks up to **10** times and lasts for **45** seconds. **2.5**-second cooldown.`,
    ...
    matrix: {
        set2: `Upon using a discharge skill to switch to the current weapon, gain a shield equal to **120%/150%/180%/210%** of ATK for **4** seconds.  
            <abbr title='China Exclusive' /> Upon using a discharge skill to switch to the current weapon, gain a shield equal to **150%/200%/250%/300%** of ATK for **6** seconds.`,
