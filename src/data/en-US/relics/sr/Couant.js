const couant = {
    ...
    advancement: {
            star1: "When the shield is broken, reduce the speed of the attacker by **35%** for **6** seconds.<br><abbr title='China Exclusive' class='cn-flag'>CN</abbr> When the shield is broken, reduce the speed of the attacker and nearby enemies by **35%** for **6** seconds.",
            
            star2: "After shield breaks, increase final damage by **20%** for **10** seconds.<br><abbr title='China Exclusive' class='cn-flag'>CN</abbr> After shield breaks, increase final damage equal to the percentage of HP lost with a minimum of **30%**, for **10** seconds.",
