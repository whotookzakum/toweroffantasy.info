const couant = {
    ...
    advancement: {
            star1: 
                ...
                <abbr title='China Exclusive' /> When the shield is broken, reduce the speed of the attacker and nearby enemies by **35%** for **6** seconds.`,
            
            star2: 
                `After shield breaks, increase final damage by **20%** for **10** seconds.  
                <abbr title='China Exclusive' /> After shield breaks, increase final damage equal to the percentage of HP lost with a minimum of **30%**, for **10** seconds.`,
