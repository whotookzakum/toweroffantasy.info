    ...
    text:
        <>
            ...
            <section>
                ...
                <p>
                    To level up a weapon, you will need <strong>Weapon EXP batteries</strong> which are obtained through <Link to="/guides/gacha">gacha</Link>, shops, password boxes, and more. Each level boosts the base stats of that weapon.
                </p>
                <p>
                    Every 10 levels, you will need <strong>Weapon Upgrade Materials</strong> to raise the level cap another 10 levels. They are obtained through <Link to="/guides/vitality">dungeons</Link>, shops, battle pass, events, and more.<br/>
                </p>
                <p>
            ...
            <section>
                ...
                <p>
                    Obtained through gacha banners, <Link to="/guides/vitality">Joint Operation</Link>, world bosses, <Link to="/guides/housing">housing</Link>, and <Link to="/guides/dailiesweeklies">Void Rifts</Link>.<br/>
                ...
                <p>
                    Matrix set effects can be upgraded by advancing <strong>every piece in the set</strong> to a higher star. For example, if you have a 2-piece set of <Link to="/matrices/shiro">Shiro Matrices</Link> and advance both pieces to 1★, the damage bonus will be increased from 15% to 19%. Basically, the next value will be used.
                </p>
                <p>
            ...
            <section>
                <h2>Armor</h2>
                <p>
                    Armor provides passive stat increases, and can be obtained through shops, <Link to="/guides/vitality">dungeons</Link>.<br/>
                ...
                <h3>Enhancement</h3>
                <p>
                    Enhancing armor requires gold and Enhancement Modules, which are obtained through shops and <Link to="/guides/dailiesweeklies">Bygone Phantasm</Link>. It will add a +1 to your armor, <strong className="yellow">boosting the fixed stats</strong> of that piece.
                </p>
                <p>
