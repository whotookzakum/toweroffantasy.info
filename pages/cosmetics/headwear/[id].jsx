...
import { getHeadwearData, getHeadwearIds } from "../../../lib/cosmetics";
import CNTag from "../../../components/CNTag";
import { Modal } from "../../../components/Modal";
import Ads from "../../../components/Ads";

export async function getStaticProps({ params }) {
    const item = await getHeadwearData(params.id);
    return {
        props: {
            item,
        },
...
export default function HeadwearModal({ item }) {
