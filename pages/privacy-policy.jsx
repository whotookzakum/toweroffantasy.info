            ...
            <ol className="outer">
                <li>
                    ...
                    <ol>
                        ...
                        {/* <li>We are registered in <insert country of registry> under registration number <insert company reg number>, and our registered office is at <insert registered address>.</li> */}
                        {/* <li>Our principal place of business is at <insert principal business address /office></li> */}
                        <li>The hosting facility for our website is located in the United States.</li>
                        {/* <li>The mailing database is located in US, Europe or UK </li> */}
                        <li>You can contact us on Discord by sending a direct message to Zakum#3080.</li>
                    </ol>
                </li>
                <li>
                    <strong>Credit</strong>
                    <ol>
                        <li>This document was created using a template from <a href="https://docular.net">Docular</a>.</li>
                    </ol>
                </li>
                <li>
                    ...
                    <ol>
                        <li>In this Section 3 we have set out:
                            <ol className="letter-list" style={{ listStyleType: "lower-alpha" }}>
                        ...
                        {/* <li>We may process your account data ("account data"). The account data may include your name and email address. The source of the account data <insert source of account data - i.e. direct from consumer or via third party connection> but only with your explicit permission. The account data may be processed for the purposes of operating our website, providing our services, ensuring the security of our website and services, maintaining back-ups of our databases and communicating with you. The legal basis for this processing is our legitimate interests, namely the proper administration of our website and business.</li> */}
                        {/* <li>We may process your information included in your personal profile on our website ("profile data"). The profile data may include <insert details of what information you collect from users for their profile on your site>. The profile data may be processed for the purposes of enabling and monitoring your use of our website and services. The legal basis for this processing is our legitimate interests, namely the proper administration of our website and business.</li> */}
                        <li>We may process your personal data that is provided in the course of the use of our services ("<b>service data</b>"). The service data may include the timing, frequency and pattern of service use. The source of the service data is you. The service data may be processed for the purposes of operating our website, providing our services, ensuring the security of our website and services, maintaining back-ups of our databases and communicating with you. The legal basis for this processing is our legitimate interests, namely the proper administration of our website and business.</li>
                ...
                <li>
                    ...
                    <ol>
                        ...
                        {/* <li>We may disclose email addresses to our suppliers or subcontractors insofar as reasonably necessary for sending you our email newsletter, if you have requested it (you can inform us at any time if you no longer require the newsletter).</li> */}
                ...
                <li>
                    <strong>International transfers of your personal data</strong>
                    <ol>
                        ...
                        {/* <li>Mailing databases are situated in the US and Australia. The European Commission has made an "adequacy decision" with respect to the data protection laws of each of these countries. Transfers to each of these countries will be protected by appropriate safeguards, namely EU-U.S. Privacy Shield and Swiss-U.S. Privacy Shield.</li> */}
                ...
                <li>
                    ...
                    <ol>
                        ...
                        <li>We will retain and delete your personal data as follows:
                            <ol className="letter-list">
                                {/* <li>Profile data containing personal data will be retained for <please summarise your policy for retaining and deleting user data>.</li> */}
                                <li>Cookie data will be retained for no longer than 30 days.</li>
                            </ol>
                        </li>
                ...
                <li>
                    ...
                    <ol>
                        ...
                        <li>We may notify you of changes to this policy on the Aida Cafe Discord server or notifications on our website.</li>
                    </ol>
                </li>
                <li>
                    ...
                    <ol>
                        ...
                        <li>Your principal rights under the data protection law are:
                            <ol>
                        ...
                        <li>You have the right to confirmation as to whether or not we process your personal data and, where we do, access to the personal data, together with certain additional information. That additional information includes details of the purposes of the processing, the categories of personal data concerned and the recipients of the personal data. Providing the rights and freedoms of others are not affected, we will supply to you a copy of your personal data. The first copy will be provided free of charge, but additional copies may be subject to a reasonable fee. Provision of such information will be subject to:
                            <ol>
                                <li>the first copy will be provided free of charge, but additional copies will be subjected to a $200 administration fee; and</li>
                ...
                <li>
                    ...
                    <ol>
                        ...
                        <li>We use third party advertisements to support our site. Some of these advertisers may be served from our third party advertiser, you can view their <a href="https://www.network-n.com/network-privacy-policy/">privacy policy</a> and <a href="https://www.network-n.com/network-cookie-policy/">cookie policy</a> here.</li>
                        <li>We use Google Analytics and Comscore to analyse the use of our website. Google Analytics and Comscore gather information about website use by means of cookies. The information gathered relating to our website is used to create reports about the use of our website. Google's privacy policy is available <a href="https://www.google.com/policies/privacy/">here</a>. Comscore's privacy policy is available <a href="https://www.comscore.com/About-comScore/Privacy-Policy">here</a>.</li>
                    </ol>
                </li>
                <li>
