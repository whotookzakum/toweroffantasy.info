...
function Food() {
    ...
    return (
        <>
            ...
            <img className="bg-img" src="/static/images/food/huodong_meishi_guo.webp" alt="Dancing Air Fryer" />
            <header>
                <h1>Food</h1>
                <p>
                    ...
                    <li>
                        ...
                        <div className="flex">
                            ...
                            <label htmlFor="atk_flame">
                                <img src="/static/images/buff/ATK_flame.webp" alt="Flame Attack" />
                            </label>
                            <input type="checkbox" id="atk_ice" name="atk_ice" />
                            <label htmlFor="atk_ice">
                                <img src="/static/images/buff/ATK_ice.webp" alt="Ice Attack" />
                            </label>
                            <input type="checkbox" id="atk_volt" name="atk_volt" />
                            <label htmlFor="atk_volt">
                                <img src="/static/images/buff/ATK_volt.webp" alt="Volt Attack" />
                            </label>
                            <input type="checkbox" id="atk_physical" name="atk_physical" />
                            <label htmlFor="atk_physical">
                                <img src="/static/images/buff/ATK_physical.webp" alt="Physical Attack" />
                            </label>
                        </div>
                    </li>
                    <li>
                        <h4>Defensive</h4>
                        <div className="flex">
                            <img src="/static/images/buff/DEF_flame.webp" alt="Flame Defense" />
                            <img src="/static/images/buff/DEF_ice.webp" alt="Ice Defense" />
                            <img src="/static/images/buff/DEF_volt.webp" alt="Volt Defense" />
                            <img src="/static/images/buff/DEF_physical.webp" alt="Physical Defense" />
                        </div>
                    </li>
                    <li>
                        <h4>Recovery</h4>
                        <div className="flex">
                            <img src="/static/images/buff/HP.webp" alt="HP Recovery" />
                            <img src="/static/images/buff/stamina.webp" alt="Stamina Recovery" />
                        </div>
                    </li>
